...
- Search results now display formatted excerpts for terminal readability
- Expanded content shown in search results
- Improved cursor-based pagination for search
...
- Page commands now output direct Confluence URLs instead of page IDs
- Improved stdin handling with explicit `-` flag support and better validation

## [1.3.0](https://github.com/grantcarthew/acon/compare/v1.2.0...v1.3.0) - 2026-01-21

### Added

- Repository and issue links displayed in version output

### Fixed

- Space key now required for `page create` and `page list` commands
- Prevented escaping of intra-word underscores in Markdown output
